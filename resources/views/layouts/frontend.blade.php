    ...
    <div class="container">
      <div class="row">
        <div class="intro-info col-md-6">
          ...
          <div class="row">
            <a href="#about" class="btn-get-started scrollto col-6 text-center">Masuk Sebagai Masyarakat</a>
            <a href="#services" class="btn-services scrollto col-6 text-center">Masuk Sebagai Petugas</a>
          </div>  
        </div>
